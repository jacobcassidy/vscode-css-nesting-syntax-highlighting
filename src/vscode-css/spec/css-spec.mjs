...
describe("CSS grammar", function () {
	...
	describe("selectors", function () {
		...
		it("tokenizes complex selectors", function () {
			...
			lines = testGrammar.tokenizeLines(
		...
		describe("pseudo-classes", function () {
			...
			describe(":nth-*()", function () {
				it("tokenizes :nth-child()", function () {
					var tokens;
					tokens = testGrammar.tokenizeLines(
						":nth-child(2n+1)\n:nth-child(2n -1)\n:nth-child(-2n+ 1)\n:nth-child(-2n - 1)\n:nth-child(odd)\n:nth-child(even)\n:nth-child(  odd   )\n:nth-child(  even  )"
					);
	...
	describe.skip("firstLineMatch", function () {
		it("recognises Emacs modelines", function () {
			...
			for (j = 0, len = ref.length; j < len; j++) {
				line = ref[j];
				assert.notEqual(
					testGrammar.grammar.firstLineRegex.scanner.findNextMatchSync(line),
					null
				);
			}
			invalid =
